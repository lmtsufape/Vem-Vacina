...
class Candidato extends Model
{
    ...
    public function getMessagemWhatsapp() {
        ...
        if ($this->aprovacao == $this::APROVACAO_ENUM[0]) {
            ...
            $mensagem = $mensagem."Para que seja realizada a aplicação da vacina, é preciso apresentar documento de identificação com foto (RG/CPF), cartão do SUS e comprovante de residência no nome da pessoa a ser vacinada.\n";
            ...
            $mensagem = $mensagem."Reforçamos a importância de que a pessoa esteja de posse de todos os documentos! A pessoa cadastrada será imunizada com a dose disponível, de acordo com o grupo escolhido, não sendo permitida a escolha de outro grupo no ato da vacinação. Agradecemos a sua atenção e ficamos à disposição para outros esclarecimentos que sejam necessários!";

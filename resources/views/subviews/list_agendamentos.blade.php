...
<div class="table-responsive">
    <table class="table table-condensed" id="myTable">
        ...
        <div class="accordion" id="accordionExample">
            @foreach ($candidatos as $i => $candidato)
                <div class="card">
                    <div
                        class="card-header  @if ($candidato->aprovacao == $candidato_enum[3]) bg-info @elseif($candidato->aprovacao == $candidato_enum[0]) bg-warning @elseif($candidato->aprovacao == $candidato_enum[1]) bg-success @elseif($candidato->aprovacao == $candidato_enum[2]) bg-danger @endif "
                        id="headingOne">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 ">
                            ...
                            <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-8">
                                ...
                                <button
                                    class="btn btn-white btn-block text-left @if ($candidato->aprovacao != $candidato_enum[0]) text-white @elseif($candidato->aprovacao == $candidato_enum[0]) text-dark  @endif "
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-1 row-cols-md-1">
                                        ...
                                        <div class="col-8 col-sm-8 col-md-12 col-lg-5 col-xl-5">
                                            <span class="d-inline-block text-truncate text-capitalize font-weight-bolder" class="d-inline-block" tabindex="0" data-toggle="tooltip"
                                                  title="{{$candidato->nome_completo}}" style="width: 23rem;">
                            ...
                            <div class="col-1 col-sm-1 col-md-1 col-lg-1 col-xl-1  text-center">
                                @can('whatsapp-candidato')
                                    @if ($candidato->dose == "1ª Dose" &&  $candidato->aprovacao != null && $candidato->aprovacao != $candidato_enum[3])
                                        <a href="https://api.whatsapp.com/send?phone=55{{$candidato->getWhatsapp()}}&text={{$candidato->getMessagemWhatsapp()}}" class="text-center text-white"
                                           target="_blank"><i class="fab fa-whatsapp fa-2x"></i></a>
                                    @elseif($candidato->dose == "2ª Dose")
                                        <a href="https://api.whatsapp.com/send?phone=55{{$candidato->getWhatsapp()}}&text={{$candidato->getMessagemSegundaDose()}}" class="text-center text-white"
                                           target="_blank"><i class="fab fa-whatsapp fa-2x"></i></a>
                                    @elseif($candidato->dose == "3ª Dose" && $candidato->aprovacao != null && $candidato->aprovacao != $candidato_enum[3] && $candidato->aprovacao != $candidato_enum[0] && $candidato->posto!=null)
                                        <a href="https://api.whatsapp.com/send?phone=55{{$candidato->getWhatsapp()}}&text={{$candidato->getMessagemDoseReforco()}}" class="text-center text-white"
                                           target="_blank"><i class="fab fa-whatsapp fa-2x"></i></a>
                                    @elseif($candidato->dose == "4ª Dose" && $candidato->aprovacao != null && $candidato->aprovacao != $candidato_enum[3] && $candidato->aprovacao != $candidato_enum[0] && $candidato->posto!=null)
                                        <a href="https://api.whatsapp.com/send?phone=55{{$candidato->getWhatsapp()}}&text={{$candidato->getMessagemDoseReforco()}}" class="text-center text-white"
                                           target="_blank"><i class="fab fa-whatsapp fa-2x"></i></a>
                                    @elseif($candidato->dose != null && $candidato->aprovacao != null && $candidato->aprovacao != $candidato_enum[3] && $candidato->aprovacao != $candidato_enum[0] && $candidato->posto!=null)
                                        @if($candidato->posto->nome == 'Domicílio')
                                            <a href="https://api.whatsapp.com/send?phone=55{{$candidato->getWhatsapp()}}&text={{$candidato->getMessagemDoseDomicilio()}}" class="text-center text-white"
                                               target="_blank"><i class="fab fa-whatsapp fa-2x"></i></a>
                                        @else
                                            <a href="https://api.whatsapp.com/send?phone=55{{$candidato->getWhatsapp()}}&text={{$candidato->getMessagemDoseReforco()}}" class="text-center text-white"
                                               target="_blank"><i class="fab fa-whatsapp fa-2x"></i></a>
                                ...
                                <div class="container">
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <a target="_blank"
                                                   href="https://servicos.receita.fazenda.gov.br/Servicos/CPF/ConsultaSituacao/ConsultaPublica.asp?CPF={{$candidato->cpf}}&NASCIMENTO={{$candidato->data_de_nascimento_dmY()}}">Validar
                                                    data de nascimento e CPF</a>
                                            </div>
                                        </div>
                                        <br>
                                        <div class="row">
                                        ...
                                        <div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input id="posto_{{$candidato->id}}" type="text" class="form-control" disabled
                                                           value="@if($candidato->posto != null){{$candidato->posto->nome}}@endif">
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input
                                                        @if (session('candidato_id', '0') == $candidato->id)
                                                        autofocus
                                                        @endif id="data_{{$candidato->id}}" type="text" class="form-control"
                                                        value="@if($candidato->posto != null){{date('d/m/Y',strtotime($candidato->chegada))}}@endif">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label for="chegada_{{$candidato->id}}">Horário de chegada</label>
                                                    <input id="chegada_{{$candidato->id}}" type="text" class="form-control" disabled
                                                           value="@if($candidato->posto != null){{date('H:i',strtotime($candidato->chegada))}}@endif">
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        @if ($lote != null)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input id="tempo_{{$candidato->id}}" type="text" class="form-control" disabled
                                                           value="{{$lote->dose_unica ?  " - " : $lote->inicio_periodo ." dias"  }}">
                                                </div>
                                            </div>
                                        @endif
                                        <br>
                                        ...
                                        @can('reagendar')
                                            <div class="row " id="agendado_para_{{$candidato->id}}" style="display: block;">
                                                ...
                                                <div class="col-md-6">
                                                    <button id="btn_edit_{{$candidato->id}}" type="button" class="btn btn-primary" style="width: 100%;" onclick="reagendar({{$candidato->id}}, true)">
                                                        Reagendar
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <form id="form_editar_agendado_para_{{$candidato->id}}" action="{{route('agendamento.posto.update', ['id' => $candidato->id])}}" method="POST">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label for="posto_vacinacao_{{$candidato->id}}" class="style_titulo_input">PONTO DE VACINAÇÃO<span class="style_titulo_campo">*</span><span
                                                                class="style_subtitulo_input"> (obrigatório)</span></label>
                                                        <select id="posto_vacinacao_{{$candidato->id}}" class="form-control style_input @error('posto_vacinacao_'.$candidato->id) is-invalid @enderror"
                                                                name="posto_vacinacao_{{$candidato->id}}" required onchange="selecionar_posto(this, {{$candidato->id}})">
    ...
    @if ($request != null && !isset($paginacao))
        <div class="row">
            <div class="col-sm-12">
                {{ $candidatos->links() }}
            </div>

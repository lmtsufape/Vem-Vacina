            ...
            <div class="container" style="margin-bottom: 35px;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="texto_do_agendamento" name="texto_do_agendamento" class="form-control"
                               value="@if(old('texto_do_agendamento')!=null){{old('texto_do_agendamento')}}@else{{$publico->texto}}@endif">
                    ...
                    <div class="col-md-4">
                        ...
                        <input id="texto_da_home" type="text" class="form-control @error('texto_da_home') is-invalid @enderror" name="texto_da_home"
                               value="@if(old('texto_da_home')!=null){{old('texto_da_home')}}@else{{$publico->texto_home}}@endif">
                ...
                <br>
                <div id="divIdade"
                     @if(old('tipo') == $tipos[0] || old('tipo') == $tipos[2] || (old('tipo') == null && $publico->tipo == $tipos[0] || $publico->tipo == $tipos[2])) style="display: block;"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input id="inicio_faixa_etaria" class="form-control @error('inicio_faixa_etária') is-invalid @enderror" type="number" name="inicio_faixa_etária" placeholder="80"
                                   value="@if(old('inicio_faixa_etária') != null){{old('inicio_faixa_etária')}}@else{{$publico->inicio_intervalo}}@endif" min="0" max="1000">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="fim_faixa_etaria" class="form-control @error('fim_faixa_etária') is-invalid @enderror" type="number" name="fim_faixa_etária" placeholder="85"
                                   value="@if(old('fim_faixa_etária') != null){{old('fim_faixa_etária')}}@else{{$publico->fim_intervalo}}@endif" min="0" max="1000">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input id="pri_dose" class="form-control @error('primeria_dose') is-invalid @enderror" type="number" name="primeria_dose" placeholder="0"
                               value="@if(old('primeria_dose') != null){{old('primeria_dose')}}@else{{$publico->total_pessoas_vacinadas_pri_dose}}@endif" min="0" max="1000000000000">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="seg_dose" class="form-control @error('segunda_dose') is-invalid @enderror" type="number" name="segunda_dose" placeholder="0"
                               value="@if(old('segunda_dose')!=null){{old('segunda_dose')}}@else{{$publico->total_pessoas_vacinadas_seg_dose}}@endif" min="0" max="1000000000000">
                ...
                <div class="row">
                    ...
                    @enderror
                    <div class="col-md-12">
                        <input type="checkbox" name="pontos[]" id="domicilio" value="{{$domicilio->id}}"
                               @if((old('pontos') != null && in_array($domicilio->id, old('pontos'))) || (old('pontos') == null && $publico->pontos != null && $publico->pontos->contains($domicilio))) checked @endif>
                    ...
                    @foreach ($pontos as $ponto)
                        @if($ponto->nome != 'Domicílio')
                            <div class="col-md-4">
                                <input type="checkbox" class="pontos" name="pontos[]" value="{{$ponto->id}}"
                                       @if((old('pontos') != null && in_array($ponto->id, old('pontos'))) || (old('pontos') == null && $publico->pontos != null && $publico->pontos->contains($ponto))) checked @endif>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <input type="checkbox" name="outras_informações" onclick="exibirOutrasInfo(this)"
                               @if(old('outras_informações') != null || (old('outras_informações') == null && $publico->outrasInfo != null && count($publico->outrasInfo) > 0)) checked @endif>
                        <label for="">Adicionar outras informações ao público</label>
                    </div>
                    <div class="col-md-6">
                        <input type="checkbox" name="outras_informações_obrigatorias"
                               @if(old('outras_informações_obrigatorias') != null || (old('outras_informações_obrigatorias') == null && $publico->outras_opcoes_obrigatorio != null && $publico->outras_opcoes_obrigatorio)) checked @endif>
                        <label for="">Deixar outras informações obrigatórias</label>
                    </div>
                </div>
                <br>
                <div id="divOutrasInfo"
                     style="@if(old('outras_informações') != null || (old('outras_informações') == null && $publico->outrasInfo != null && count($publico->outrasInfo) > 0)) display: block; @else display: none; @endif">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea name="texto_das_outras_informações" class="form-control" id="texto_das_outras_informações" cols="30" rows="5"
                                      placeholder="Insira aqui o texto informativo">@if(old('texto_das_outras_informações') != null){{old('texto_das_outras_informações')}}@else{{$publico->texto_outras_informacoes}}@endif</textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">

                            ...
                            <form method="POST" id="formSolicitar" class="needs-validation" action="{{ route('solicitacao.candidato.enviar') }}" enctype="multipart/form-data">
                                    ...
                                    @auth
                                        @if ($publico->tipo == $tipos[0])
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" @if ($candidato->etapa->id == $publico->id) checked  @endif id="publico_{{$publico->id}}" name="público" value="{{$publico->id}}" checked >
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control style_input apenasLetras @error('nome_completo') is-invalid @enderror" id="inputNome" placeholder="Digite seu nome completo" name="nome_completo" value="{{ $candidato->nome_completo }}" maxlength="65"  readonly >
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control style_input @error('data_de_nascimento') is-invalid @enderror" id="inputData" placeholder="dd/mm/aaaa" pattern="[0-9]{2}/[0-9]{2}/[0-9]{4}" name="data_de_nascimento" value="{{ $candidato->data_de_nascimento }}"  readonly>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control style_input sus @error('número_cartão_sus') is-invalid @enderror" id="inputCartaoSUS" placeholder="000 0000 0000 0000" name="número_cartão_sus" value="{{ $candidato->numero_cartao_sus }}" readonly >
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select id="inputSexo" class="form-control style_input @error('sexo') is-invalid @enderror" name="sexo" readonly >
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control style_input apenasLetras @error('nome_da_mãe') is-invalid @enderror" id="inputNomeMae" placeholder="Digite o nome completo da mãe" name="nome_da_mãe" value="{{ $candidato->nome_da_mae }}" maxlength="65" readonly >
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control style_input celular @error('telefone') is-invalid @enderror" id="inputTelefone" placeholder="Digite o número do seu telefone" name="telefone" value="{{ $candidato->telefone }}"  >
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control style_input celular @error('whatsapp') is-invalid @enderror" id="inputCelular" placeholder="Digite o número do seu whatsapp" name="whatsapp" value="{{ $candidato->whatsapp }}"  >
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="email" class="form-control style_input" id="inputEmail" placeholder="Digite o seu e-mail" name="email" value="{{ $candidato->email }}"  >
                                        @error('email')
                                            <div id="validationServer05Feedback" class="invalid-feedback">
                                                <strong>{{$message}}</strong>
                                            </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control style_input cep @error('cep') is-invalid @enderror" id="inputCEP" placeholder="Digite o CEP" name="cep" value="{{ $candidato->cep }}"  >
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="inputCidade" class="form-control style_input @error('cidade') is-invalid @enderror" name="cidade" value="{{ $candidato->cidade }}" readonly >
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control style_input @error('rua') is-invalid @enderror" id="inputrua" placeholder="Digite o nome da rua, avenida, travessa..." name="rua" value="{{$candidato->logradouro}}"  >
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control style_input @error('número_residencial') is-invalid @enderror" id="inputNumeroResidencia" placeholder="Digite o número da residência" name="número_residencial" value="{{ $candidato->numero_residencia }}"  >
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea type="text" class="form-control style_input @error('complemento_endereco') is-invalid @enderror" id="inputComplemento" placeholder="" rows="3" name="complemento_endereco"  >{{ $candidato->complemento_endereco }}</textarea>

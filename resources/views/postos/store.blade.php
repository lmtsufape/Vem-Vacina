                ...
                <form action="{{ route('postos.store') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md">
                            ...
                            <input id="funciona_domingo" type="checkbox" name="funciona_domingo" @if(old('funciona_domingo')) checked @endif>
                            <label for="funciona_domingo">Funciona nos domingos</label>
                            <br>

                            <input id="funciona_segunda" type="checkbox" name="funciona_segunda" @if(old('funciona_segunda')) checked @endif>
                            <label for="funciona_segunda">Funciona nas segundas</label>
                            <br>

                            <input id="funciona_terca" type="checkbox" name="funciona_terca" @if(old('funciona_terca')) checked @endif>
                            <label for="funciona_terca">Funciona nas terças</label>
                            <br>

                            <input id="funciona_quarta" type="checkbox" name="funciona_quarta" @if(old('funciona_quarta')) checked @endif>
                            <label for="funciona_quarta">Funciona nas quartas</label>
                            <br>

                            <input id="funciona_quinta" type="checkbox" name="funciona_quinta" @if(old('funciona_quinta')) checked @endif>
                            <label for="funciona_quinta">Funciona nas quintas</label>
                            <br>

                            <input id="funciona_sexta" type="checkbox" name="funciona_sexta" @if(old('funciona_sexta')) checked @endif>
                            <label for="funciona_sexta">Funciona nas sextas</label>
                            <br>

                            <input id="funciona_sabado" type="checkbox" name="funciona_sabado" @if(old('funciona_sabado')) checked @endif>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <input onchange="check_funcionamento(this, 'seletores_funcionamento_manha')" id="funcionamento_manha" type="checkbox" name="funcionamento_manha" @if(old('funcionamento_manha')) checked @endif>
                    ...
                    <div id="seletores_funcionamento_manha" class="row"  @if(!(old('funcionamento_manha'))) style="display: none;" @endif >
                        <div class="col-md-4">
                            ...
                            <select name="inicio_atendimento_manha" class="form-control">
                                ...
                                @for($i = 5; $i <= 12; $i++)
                                   <option value="{{$i}}" @if(old('inicio_atendimento_manha') == $i) selected @endif >{{$i}} hrs</option>
                                @endfor
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="fim_atendimento_manha" class="form-control">
                                <option disabled selected> -- hrs</option>
                                @for($i = 5; $i <= 12; $i++)
                                   <option value="{{$i}}" @if(old('fim_atendimento_manha') == $i) selected @endif >{{$i}} hrs</option>
                                @endfor
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input min="1" max="60" type="number" class="form-control" style="width: 75%;" name="intervalo_atendimento_manha" value="{{old('intervalo_atendimento_manha')}}">
                    ...
                    <div class="row">
                        <div class="col-md">
                            <input onchange="check_funcionamento(this, 'seletores_funcionamento_tarde')" id="funcionamento_tarde" type="checkbox" name="funcionamento_tarde" @if(old('funcionamento_tarde')) checked @endif>
                    ...
                    <div id="seletores_funcionamento_tarde" class="row" @if(!(old('funcionamento_tarde'))) style="display: none;" @endif>
                        <div class="col-md-4">
                            <label style="margin-right: 8%;">Inicio:</label>
                            <select name="inicio_atendimento_tarde" class="form-control">
                                <option disabled selected> -- hrs</option>
                                @for($i = 13; $i <= 18; $i++)
                                   <option value="{{$i}}" @if(old('inicio_atendimento_tarde') == $i) selected @endif >{{$i}} hrs</option>
                                @endfor
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="fim_atendimento_tarde" class="form-control">
                                <option disabled selected> -- hrs</option>
                                @for($i = 13; $i <= 18; $i++)
                                   <option value="{{$i}}" @if(old('fim_atendimento_tarde') == $i) selected @endif>{{$i}} hrs</option>
                                @endfor
                            </select>
                        ...
                        <div class="col-md-4">
                            <label style="margin-right: 8%;">Intervalo (mins):</label>
                            <input min="1" max="60" type="number" class="form-control" style="width: 75%;" name="intervalo_atendimento_tarde" value="{{old('intervalo_atendimento_tarde')}}">

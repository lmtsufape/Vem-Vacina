                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row" style="text-align: center;">
                                ...
                                <div class="col-md-12 style_card_apresentacao_subtitulo">A plataforma “Vem Vacina Garanhuns” é a ferramenta oficial da Secretaria de Saúde de Garanhuns, desenvolvida em
                                    parceria com a Universidade Federal do Agreste de Pernambuco, para cadastro e agendamento da vacinação contra a Covid-19.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12" style="margin-bottom: 32px;">
                            <div class="row ">
                                ...
                                <div class="col-md-12 style_card_apresentacao_solicitar_vacina_subtitulo" style="text-align: justify;">Clique para solicitar e agendar sua vacinação, ou realizar
                                    cadastro na fila de espera (é necessário aguardar aprovação da solicitação pela Secretaria de Saúde).
                                </div>
                            <!--
                                    @auth
                        ...
                        <div class="col-md-12" style="margin-bottom: 32px;">
                            <div class="row">
                                ...
                                <div class="col-md-12 style_card_apresentacao_solicitar_vacina_subtitulo" style="text-align: justify; padding-bottom: 19px;">Clique para saber se o seu agendamento já
                                    foi aprovado ou encontra-se na fila de espera.
                                </div>
                                <a type="button" class="btn btn-primary style_card_apresentacao_botao" style="color: white;margin-top:1.8rem;" data-toggle="modal"
                                   data-target="#modalChecarAgendamento">CONSULTAR AGENDAMENTO DA VACINA</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row justify-content-center">
            <div class="card_media2" style="margin-top: 1rem;">
                <div class="card_menor3">
                    <div class="card-header style_card_menor_titulo" style=" border-top-left-radius: 12px; border-top-right-radius: 12px; ">INFORMAÇÕES E FORMULÁRIOS PARA VACINAÇÃO CONTRA A COVID-19
                    </div>
                            ...
                            <div class="container">
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="anexos6" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading0">
                                            <div class="panel-body px-3 mb-4">
                                                ...
                                                <a href="{{route('baixar.anexo', ['name'=> 'NOTA_TECNICA_SIDI_3-2022.pdf'])}}" class="btn btn-success " target="_blank" style="color:white;">Baixar Nota
                                                    Técnica</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="panel panel-default">
                                        <div class="panel-heading p-3 mb-3" role="tab" id="heading0" style="border-radius: 8px;">
                                            <h3 class="panel-title">
                                                <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#anexos5" aria-expanded="true"
                                                   aria-controls="anexos5">
                                        ...
                                        <div id="anexos5" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading0">
                                            <div class="panel-body px-3 mb-4">
                                                <p style="text-align: justify">
                                                    Nota Técnica do Governo do Estado de Pernambuco com orientações referentes a aplicação das doses de reforço para a população de idosos acima de 60
                                                    anos (que tenham completado o esquema vacinal há seis meses), e imunossuprimidos (com o esquema vacinal completo há 28 dias ou mais).
                                                </p>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading p-3 mb-3" role="tab" id="heading0" style="border-radius: 8px;">
                                            <h3 class="panel-title">
                                                <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#anexos4" aria-expanded="true"
                                                   aria-controls="anexos4">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading p-3 mb-3" role="tab" id="heading0" style="border-radius: 8px;">
                                                <h3 class="panel-title">
                                                    <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#anexos3" aria-expanded="true"
                                                       aria-controls="anexos3">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading p-3 mb-3" role="tab" id="heading0" style="border-radius: 8px;">
                                                    <h3 class="panel-title">
                                                        <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#anexos2" aria-expanded="true"
                                                           aria-controls="anexos2">
                                                ...
                                                <div id="anexos2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading0">
                                                    <div class="panel-body px-3 mb-4">
                                                        <p style="text-align: justify">
                                                            A comprovação das comorbidades deve ser feita no ato da vacinação. Para isso, a Secretaria de Saúde produziu um modelo de atestado, onde o
                                                            profissional de saúde poderá indicar a doença preexistente do paciente. É obrigatório o carimbo, matrícula e/ou registro do conselho de
                                                            classe do profissional.
                                                        </p>
                                                        <a href="{{route('baixar.anexo', ['name'=> 'anexo3.pdf'])}}" class="btn btn-success " target="_blank" style="color:white;">Baixar
                                                            Formulário </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-default">
                                                <div class="panel-heading p-3 mb-3" role="tab" id="heading0" style="border-radius: 8px;">
                                                    <h3 class="panel-title">
                                                        <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#feedCollapse" aria-expanded="true"
                                                           aria-controls="feedCollapse">
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="anexos2" class="panel-collapse collapse " role="tabpanel" aria-labelledby="heading0">
                                                    <div class="panel-body px-3 mb-4">
                                                        <p style="text-align: justify">
                                                            Através deste documento, a gestante ou puérpera poderá ter acesso as informações necessárias sobre a vacinação. No mesmo deverão ser
                                                            preenchidos os dados de identificação, além da autorização para que a vacina seja administrada.
                                                        </p>
                                                        <a href="{{route('baixar.anexo', ['name'=> 'Termo de Ciência e Consentimento Vacinação contra a Covid - GESTANTE.docx'])}}"
                                                           class="btn btn-success " target="_blank" style="color:white;">Baixar Formulário </a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-default">
                                                <div class="panel-heading p-3 mb-3" role="tab" id="heading0" style="border-radius: 8px;">
                                                    <h3 class="panel-title">
                                                        <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#anexos0" aria-expanded="true"
                                                           aria-controls="anexos0">
                                                            Pessoas com comorbidades
                                                        </a>
                                                    </h3>
                                                </div>
                                                <div id="anexos0" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading0">
                                                    <div class="panel-body px-3 mb-4">
                                                        <p style="text-align: justify">
                                                            A comprovação das comorbidades deve ser feita no ato da vacinação. Para isso, a Secretaria Estadual de Saúde produziu um modelo de atestado
                                                            aonde um profissional de saúde poderá indicar a doença preexistente do paciente. É obrigatório o carimbo, matrícula e/ou registro do
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-heading p-3 mb-3" role="tab" id="heading0" style="border-radius: 8px;">
                                                    <h3 class="panel-title">
                                                        <a class="collapsed" role="button" title="" data-toggle="collapse" data-parent="#accordion" href="#anexos1" aria-expanded="true"
                                                           aria-controls="anexos1">
                                                ...
                                                <div id="anexos1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading0">
                                                    <div class="panel-body px-3 mb-4">
                                                        <p style="text-align: justify">
                                                            Trata das orientações da estratégia de vacinação dos grupos de pessoas com comorbidades, pessoas com deficiência permanente, gestantes e
                                                            puérperas na Campanha Nacional de Vacinação contra a COVID-19, 2021.
                                                        </p>
                                                        <a href="{{route('baixar.anexo', ['name'=> 'nota.pdf'])}}" class="btn btn-success " target="_blank" style="color:white;">Baixar Nota
                                                            Técnica </a>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    @enderror --}}
                                    <label for="inputData" class="style_titulo_input">DATA DE NASCIMENTO <span class="style_titulo_campo">*</span><span
                ...
                <div class="modal-body">
                    <form id="consultar_agendamento_numSus" action="{{route('agendamento.consultarNumSus')}}" method="POST">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="inputNumSus" class="style_titulo_input">Número Cartão SUS <span class="style_titulo_campo">*</span><span
                                            class="style_subtitulo_input"> (obrigatório)</span> </label>
                                    <input type="text" class="form-control style_input sus @error('numSus') is-invalid @enderror" id="inputNumSus" placeholder="Ex.: 000 0000 0000 0000" name="numSus"
                                           value="{{old('numSus')}}">
...
<!-- Alternancia do tipo da consulta do agendamento -->
    <script type="text/javascript">
        ...
        document.getElementById("consultaNumSus").onclick = function () {
            ...
            setTimeout(() => {
                $("#modalChecarAgendamentoNumSus").modal();
            }, 500);
        };

                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="input-group" style="margin-top: 32px">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <input type="checkbox" name="desabilitar_cpf" aria-label="Checkbox for following text input" @if($dose->desabilitar_cpf) checked @endif>
                                    </div>
                                </div>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">
                                            ...
                                            <input type="checkbox" name="etapa_id[]" @if($dose->etapas->find($etapa->id)) checked @endif value="{{ $etapa->id }}"

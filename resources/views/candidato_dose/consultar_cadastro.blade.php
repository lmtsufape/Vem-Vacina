        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-9 style_card_apresentacao">
                <div class="container" style="padding-top: 10px;">
                    <form action="{{ route('reforco.verificar_dose') }}" method="post">
                        @csrf
                        <input type="hidden" value="{{$id}}" name="dose_id">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        @if(!$dose->desabilitar_cpf)
                                            <label for="inputCPF" class="style_titulo_input">CPF <span class="style_titulo_campo">*</span><span class="style_subtitulo_input"> (obrigatório)</span>
                                            </label>

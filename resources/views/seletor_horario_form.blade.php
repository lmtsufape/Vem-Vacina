...
@else
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            <label for="dia_vacinacao" class="style_titulo_input">DIA DA VACINÇÃO <span class="style_subtitulo_input">(obrigatório)</span></label>
    ...
    @foreach($horarios_por_dia as $dia => $horarios)
        <div class="seletor_horario_dia_div"  id="seletor_horario_dia_{{$dia}}" style="display:none;">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="dia_vacinacao" class="style_titulo_input">HORÁRIO DA VACINÇÃO<span class="style_subtitulo_input">(obrigatório)</span></label>
